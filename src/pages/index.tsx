    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="هدف ما در جامعه حافظ‌لایو آشنایی مردم جهان و بزرگ داشت حافظ بزرگترین غزل سرای تاریخ است.آشنایی مردم ایران و جهان با فرهنگ یک ملت پرغرور و پر آوازه در شعرسرایی"/>
            </Head>
            ...
            <Main>
                ...
                <section className={styles.homeAboutUs}>
                    ...
                    <h2>
                        <strong>هدف ما در جامعه حافظ‌لایو آشنایی مردم جهان و بزرگ داشت حافظ بزرگترین غزل سرای تاریخ است.</strong>
